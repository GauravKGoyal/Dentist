...
namespace Dentist
{
    public class AutoMapperConfig
    {
        ...
        {
            Mapper.CreateMap<Person, PersonListView>();
            Mapper.CreateMap<Person, PatientListView>();
            Mapper.CreateMap<Person, DoctorListView>();

            Mapper.CreateMap<Practice, SchedulerPracticeView>();
            Mapper.CreateMap<Person, SchedulerDoctorView>();
                //.ForMember(d => d.Practices, opt => opt.MapFrom(s => s.Practices));

            Mapper.CreateMap<Person, PatientView>()
                .ForMember(d => d.PatientViewPracticeId, opt => opt.MapFrom(s => s.Practices.First().Id));
            Mapper.CreateMap<PatientView, Person>().ForMember(d => d.Practices, opt => opt.Ignore());

            Mapper.CreateMap<Person, DoctorView>()
                .ForMember(d => d.Id, opt => opt.MapFrom(s => s.Id));
            Mapper.CreateMap<DoctorView, Person>().ForMember(d => d.Practices, opt => opt.Ignore())
                .ForMember(d => d.Id, opt => opt.MapFrom(s => s.Id));

            Mapper.CreateMap<Person, PersonView>();
            Mapper.CreateMap<PersonView, Person>().ForMember(d => d.Practices, opt => opt.Ignore());
            ...
            Mapper.CreateMap<DailyAvailabilityView, DailyAvailability>()
                ...
                .ForMember(d => d.PersonId, opt => opt.MapFrom(s => s.DailyAvailabilityViewPersonId));
